    ...
    if chain_type == 'Heavy':
        ...
        for gene_type, (pivot_df, row_label, col_label, title, caption) in plots_to_render:
            if gene_type == 'V':
                with cols[0]:  # Match IGHV plot width
                    ...
                    st.plotly_chart(fig, width='stretch', config={}, key=f"inferred_{chain_type.lower()}_v_plot")
            elif gene_type == 'J':
                with cols[2]:  # Match IGHJ plot width
                    ...
                    st.plotly_chart(fig, width='stretch', config={}, key=f"inferred_{chain_type.lower()}_j_plot")
    else:
        ...
        for i, (gene_type, (pivot_df, row_label, col_label, title, caption)) in enumerate(plots_to_render):
            with cols[i]:  # Match V and J plot widths
                ...
                st.plotly_chart(fig, width='stretch', config={}, key=f"inferred_light_{gene_type.lower()}_plot_{i}")
